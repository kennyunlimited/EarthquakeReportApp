...
//    }
    ...
    private static URL createURL(String stringUrl) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Problem building the url ", e1);
        }
        return url;
    }
    ...
    public static List<Earthquake> fetchEartquakeData(String requestUrl) {
        ...
        Log.i(LOG_TAG, "TEST: fetchEartquakeData() called ....");
        // Create URL object
